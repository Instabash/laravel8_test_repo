        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
                <div class="carousel-caption text-center">
                    ...
                    <a href="shop.html" class="btn btn-sm animated-b    utton gibson-three mt-4">Shop Now</a>
                </div>
            </div>
            <div class="carousel-item item2">
                <div class="carousel-caption text-center">
                    <h3>Want to sell?
                        <span>Post an advertisement for your motorbike or spareparts you want to sell.</span>
                    </h3>
                    <a href="shop.html" class="btn btn-sm animated-button gibson-three mt-4">Post an Ad.</a>
                </div>
            </div>
            <div class="carousel-item item3">
                <div class="carousel-caption text-center">
                    <h3>Confused on which is best?
                        <span>Compare motorbikes to see which suits your needs and budget.</span>
                    </h3>
                    <a href="shop.html" class="btn btn-sm animated-button gibson-three mt-4">Compare now.</a>

                </div>
            </div>
            <div class="carousel-item item4">
                <div class="carousel-caption text-center">
                    <h3>Does your motorbike not work like it used to?
                        <span>Modify or perform Alterations on your motorbike to increase its durability.</span>
                    </h3>
                    <a href="shop.html" class="btn btn-sm animated-button gibson-three mt-4">Check it out.</a>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 product-men women_two">
                    <div class="product-googles-info googles">
                        <div class="men-pro-item">
                            <div class="men-thumb-item">
                                <img src="{{asset("assets/images/s2.jpg")}}" class="img-fluid" alt="">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="single.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                ...
                <div class="col-md-3 product-men women_two">
                    <div class="product-googles-info googles">
                        <div class="men-pro-item">
                            <div class="men-thumb-item">
                                <img src="{{asset("assets/images/s3.jpg")}}" class="img-fluid" alt="">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="single.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                ...
                <div class="col-md-3 product-men women_two">
                    <div class="product-googles-info googles">
                        <div class="men-pro-item">
                            <div class="men-thumb-item">
                                <img src="{{asset("assets/images/s4.jpg")}}" class="img-fluid" alt="">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="single.html" class="link-product-add-cart">Quick View</a>
                                    </div>
            ...
            <div class="row mt-lg-3 mt-0">
                ...
                <div class="col-md-3 product-men women_two">
                    <div class="product-googles-info googles">
                        <div class="men-pro-item">
                            <div class="men-thumb-item">
                                <img src="{{asset("assets/images/m2.jpg")}}" class="img-fluid" alt="">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="single.html" class="link-product-add-cart">Quick View</a>
                                    </div>
